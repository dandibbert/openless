...
export function normalizeFoundryLanguageHintForUi(value: string): FoundryLocalAsrLanguageHint {
  return value === 'zh' || value === 'en' ? value : '';
}

export function normalizeSherpaLanguageHintForUi(value: string): SherpaOnnxLanguageHint {
  return value === 'zh' || value === 'en' || value === 'ja' || value === 'ko' || value === 'yue'
    ? value
    : '';
}

export function normalizeFoundryRuntimeSourceForUi(value: string): FoundryRuntimeSource {
...
export function formatFoundrySizeMb(fileSizeMb: number | null | undefined): string | null {
