...
export const zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      sonioxEndpointSchemeInvalid: 'Soniox 实时 ASR 走 WebSocket 网关，接口地址必须以 wss:// 开头（默认 wss://stt-rt.soniox.com/transcribe-websocket）；https:// 的地址在此不可用。',
