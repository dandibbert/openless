...
export const zhTW: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      sonioxEndpointSchemeInvalid: 'Soniox 即時 ASR 走 WebSocket 閘道，接口地址必須以 wss:// 開頭（預設 wss://stt-rt.soniox.com/transcribe-websocket）；https:// 的地址在此不可用。',
