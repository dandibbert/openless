...
export const ja: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      sonioxEndpointSchemeInvalid: 'Soniox リアルタイム ASR は WebSocket ゲートウェイを使用します。エンドポイントは wss:// で始まる必要があります（既定: wss://stt-rt.soniox.com/transcribe-websocket）。https:// の URL はここでは使用できません。',
