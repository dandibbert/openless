...
export const ko: typeof zhCN = {
  ...
  settings: {
    ...
    providers: {
      ...
      sonioxEndpointSchemeInvalid: 'Soniox 실시간 ASR은 WebSocket 게이트웨이를 사용합니다. 엔드포인트는 wss://로 시작해야 합니다(기본값: wss://stt-rt.soniox.com/transcribe-websocket). https:// 주소는 여기서 사용할 수 없습니다.',
