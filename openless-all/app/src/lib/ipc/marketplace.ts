...
export function downloadMarketplacePack(packId: string, targetPath: string): Promise<void> {
  return invokeOrMock('marketplace_download', { packId, targetPath }, () => undefined);
}
