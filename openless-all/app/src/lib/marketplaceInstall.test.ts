...
assert(
  !isMarketplaceInstallActive('pack-a', 'pack-b'),
  'active state does not leak to another pack',
);
assert(shouldCloseMarketplaceDetail('pack-a', 'pack-a'), 'completed pack closes its own detail');
assert(
  !shouldCloseMarketplaceDetail('pack-b', 'pack-a'),
  'completed pack does not close another detail',
);
