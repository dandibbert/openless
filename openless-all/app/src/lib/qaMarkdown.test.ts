...
assertNotIncludes(
  ...
  'raw html img should not become live dom tag',
);
...
const goodMarkdown = renderQaMarkdown(
...
assertIncludes(
  ...
  'safe query link should keep a single escaped ampersand',
);
...
assertIncludes(
  codeSnippet,
  '&lt;div class=&quot;x&quot;&gt;',
  'inline code should stay single-escaped',
);
