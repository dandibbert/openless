...
export const OL_DATA: MockData = {
  ...
  styles: [
    {
      ...
      desc: '忠实转写',
      active: false,
      sample: '嗯那个我刚刚看了下新出的电影预告片，挺有意思的你有空也看看。',
    },
    {
      id: 'light',
      name: '轻度润色',
      desc: '去口癖保语气',
      active: false,
      sample: '我刚刚看了一下新出的电影预告片，挺有意思的，你有空也看看。',
    },
    {
      id: 'clear',
      name: '清晰结构',
      desc: '结构化整理',
      active: true,
      sample: '刚看了新电影预告片，挺有意思。建议有空看一下，反馈下你的想法。',
    },
    {
      id: 'formal',
      name: '正式表达',
      desc: '正式书面',
      active: false,
      sample: '我刚刚观看了新电影的预告片，内容颇具新意。如有时间，建议你也观看，并分享你的看法。',
    },
  ],
  vocab: [
    { word: 'LLM', count: 8 },
    { word: 'macOS', count: 8 },
    { word: 'openless', count: 4 },
    { word: 'iOS', count: 3 },
    { word: 'GitHub', count: 3 },
    { word: 'Codex', count: 2 },
    { word: 'Cloud', count: 2 },
    ...
    { word: 'Swift', count: 0 },
    { word: 'LLMAPI', count: 0 },
    { word: 'TypeLazyWordsForm', count: 0 },
    { word: 'Meta', count: 0 },
    { word: 'Beta', count: 0 },
    { word: 'How', count: 0 },
    { word: 'Request', count: 0 },
    { word: 'Pull', count: 0 },
    { word: 'Table', count: 0 },
    { word: 'README', count: 0 },
    { word: 'issue', count: 0 },
  ...
  history: [
    ...
    },
    {
      ...
      dur: '31″',
      preview:
        '嗯，DOS 文件移到文件里面，然后 Windows 这个直接删除，Windows 没有共享代码，同步更新 cloud 点 MD，Windows 直接删除。',
    },
    {
      time: '13:23',
      style: '清晰结构',
    ...
    },
    {
      ...
      style: '清晰结构',
      dur: '12″',
      preview: '现在整理一下整体的项目逻辑和结构，把项目结构化梳理，并将不需要的部分移入归档。',
    },
    {
      time: '12:50',
      style: '清晰结构',
    ...
    },
    {
      ...
      style: '轻度润色',
      dur: '14″',
      preview: '把这两个 tab 合并到一起，名字就叫「设置」，把帮助中心收到右上角问号入口。',
    },
    {
      time: '11:48',
      style: '清晰结构',
      dur: '28″',
      preview:
        '设计新版本结构：本地语音交互桌面端，跨平台（Mac OS + Windows），重新设计界面，重新梳理逻辑。',
    },
  ],
};
