...
public:
  ...
  HRESULT SubmitTextFromPipe(const std::wstring &session_id, const std::wstring &text,
...
private:
  ...
  HRESULT CommitTextOnOwnerThread(const std::wstring &session_id, const std::wstring &text,
